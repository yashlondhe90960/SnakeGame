...
public class ThreadsController extends Thread{
    ...
    int sizeSnake=3;
    long speed=50;
    public static int directionSnakeGame;
    ...
    public void run(){
        while(true){
            moveInterne(directionSnakeGame);
            checkCollision();
            moveExterne();
            deleteTail();
            pauser();
    ...
    //put food iin a position and displays it
    ...
    //Moves the head of the snake and refreshes the position in the arraylist
    ...
    //Refreshes the tail of the snake, by removing the superflous data in position
